      ...
      <div className="border border-slate-200 rounded-lg shadow-sm md:pt-4">
        ...
        <div className="p-4 w-full h-auto">
          <div>
            ...
            <p className="mb-2 text-[#00856F] font-bold text-sm">
              {membro.cargo}
            </p>
          </div>
          <div className="w-full h-auto flex flex-col md:flex-row gap-4 pt-4 text-[#00856F] font-bold">
            <a
              ...
              target="_black"
              className="flex flex-1 gap-1 items-center justify-center bg-[#DCE9E2] transition duration-300 hover:bg-[#ebebeb] rounded p-2"
            >
